...
from app.chatbot.engine import BakeryChatbot, STORE_DATA_PATH
from scripts.build_site_data import build_site_data, write_output_files
...
def main() -> None:
    ...
    print(f"Workflow: {health['workflow']}")
